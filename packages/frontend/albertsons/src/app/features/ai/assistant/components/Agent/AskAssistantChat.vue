...
import MessageWrapper from '@design/src/components/AskAssistantChat/messages/MessageWrapper.vue';
import ThinkingMessage from '@design/src/components/AskAssistantChat/messages/ThinkingMessage.vue';
import { useI18n } from '@design/src/composables/useI18n';
import type { ChatUI, RatingFeedback, WorkflowSuggestion } from '@design/src/types/assistant';
import {
	isTaskAbortedMessage,
	isToolMessage,
	isThinkingGroupMessage,
} from '@design/src/types/assistant';
import AssistantIcon from '@design/src/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantLoadingMessage from '@design/src/components/AskAssistantLoadingMessage/AssistantLoadingMessage.vue';
import AssistantText from '@design/src/components/AskAssistantText/AssistantText.vue';
import InlineAskAssistantButton from '@design/src/components/InlineAskAssistantButton/InlineAskAssistantButton.vue';
import N8nButton from '@design/src/components/N8nButton';
import N8nIcon from '@design/src/components/N8nIcon';
import N8nPromptInput from '@design/src/components/N8nPromptInput';
import N8nPromptInputSuggestions from '@design/src/components/N8nPromptInputSuggestions';
import N8nScrollArea from '@design/src/components/N8nScrollArea/N8nScrollArea.vue';
import { getSupportedMessageComponent } from '@design/src/components/AskAssistantChat/messages/helpers';
